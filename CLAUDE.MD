...
- **Dataset**: GTFS export in `export/` folder (796 MB stop_times.txt!)
...
- **Large scale**: 796 MB stop_times.txt (may need subsetting)
...
## Next Action
👉 **Start Phase 1**: Read `docs/PART1.MD` and begin data import planning
